		...
		echo 	"<div class='rec'>
					...
					<div class='left_column'>
						...
						<div class='total_kkal_to_eat'>
							<div class='wrap_kkal_to_eat'>ККал<br/><span>".round($row['portions']*$row['kkal']/100)."</span></div>
							<div class='wrap_proteins_to_eat'>Б<br/><span>".round($row['portions']*$row['proteins']/100)."</span></div>
							<div class='wrap_fats_to_eat'>Ж<br/><span>".round($row['portions']*$row['fats']/100)."</span></div>
							<div class='wrap_carboh_to_eat'>У<br/><span>".round($row['portions']*$row['carboh']/100)."</span></div>
						</div>
					</div>
